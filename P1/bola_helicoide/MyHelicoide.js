...
class MyHelicoide extends THREE.Object3D {
    constructor(gui,titleGui) {
        ...
        var origen = {p:0, x:this.guiControls.radio,y:0};
        var destino = { p:1,x:this.guiControls.radio ,y:altura};

        var that = this;

        this.antiguo_radio = this.guiControls.radio;
        
        var helicoide = new TWEEN.Tween(origen).to(destino,10000).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(()=>{
